...
<body class="seo_version">
        ...
        <nav class="megamenu navbar navbar-default">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="/static/calendar.html"><img src="/static/images/logos/logo-seo.png" alt="image"></a>
                </div>
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right menu-top">
                        ...
                        <li><a href="/static/case-study.html">Case Study</a></li>
                        <li><a href="/static/pricing.html">Pricing</a></li>
                        <li><a href="/static/signup.html">Sign Up</a></li>
                        <li><a href="/static/login.html">Log In</a></li>
                    </ul>
                </div>
            </div>
        </nav>
    ...
    <div id="home" class="parallax first-section" data-stellar-background-ratio="0.4" style="background-image:url('/static/images/parallax_12.jpg');">
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-sm-12">
                    <div class="big-tagline">
                        <h2>Aqui va nuestra frase<br> representativa</h2>
                        <p class="lead">Con TravelOrg tendras kjsndkdfgjd sukdhsief kjnsdisjegopof</p>
                ...
                <div class="app_iphone_02 wow slideInUp hidden-xs hidden-sm" data-wow-duration="1s" data-wow-delay="0.5s">
                    <img src="/static/images/rocket.png" alt="" class="img-responsive">
                </div>
            </div><!-- end row -->
        </div><!-- end container -->
    </div><!-- end section -->
                    ...
                    <div class="testi-carousel owl-carousel owl-theme">
                        ...
                        <div class="testimonial clearfix">
                            ...
                            <div class="testi-meta">
                                <img src="/static/images/testi_03.png" alt="" class="img-responsive alignleft">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div class="post-media wow fadeIn">
                        <img src="/static/images/about_01.jpg" alt="" class="img-responsive img-rounded">
                ...
                <div class="col-md-6 m40">
                    <div class="message-box">
                        <h4>Oranizador de viajes</h4>
                        <h2>Somos TravelOrg</h2>
			...
			<div class="seo-services row clearfix">
                <div class="col-md-3 col-sm-6 col-xs-12">
					<div class="who">
						<img src="/static/images/seo-icons/research.svg" alt="icon" class="wow fadeInUp">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
					<div class="who">
						<img src="/static/images/seo-icons/stopwatch.svg" alt="icon" class="wow fadeInUp">
						<h4>Save Time + Money</h4>
						<p class="lead">Te ahorramos tiempo en buscar distintos eventos/paquetes y ofrecerte los que más te convengan para país que estes viajando</p>
					</div>
                </div><!-- end col -->
    ...
    <section class="section nopad cac text-center">
        <a href="login.html"><h3>¿Interesado en armar una de las mejores experiencias de tu vida? ¡Regístrate! </h3></a>
    </section>
        ...
        <div class="container">
            ...
            <div class="owl-screenshots owl-carousel owl-theme text-center">
                <div class="owl-screen">
                    <div class="service-widget">
                        <div class="post-media entry wow fadeIn">
                            <a href="/static/images/version_01.jpg" data-rel="prettyPhoto[gal]" class="hoverbutton global-radius"><i class="flaticon-unlink"></i></a>
                            <img src="/static/images/version_01.jpg" alt="" class="img-responsive img-rounded">
                ...
                <div class="owl-screen">
                    <div class="service-widget">
                        <div class="post-media entry wow fadeIn">
                            <a href="/static/images/version_05.jpg" data-rel="prettyPhoto[gal]" class="hoverbutton global-radius"><i class="flaticon-unlink"></i></a>
                            <img src="/static/images/version_05.jpg" alt="" class="img-responsive img-rounded">
                            <div class="magnifier"></div>
                        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div id="logo-carousel" class="owl-carousel">
					<div> <img src="/static/images/logo_01.png" alt=""> </div>
                    <div> <img src="/static/images/logo_02.png" alt=""> </div>
                ...
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="widget clearfix">
                        <div class="widget-title">
                            <img src="/static/images/logos/logo-light.png" alt="">
                        </div>
                        <p> TravelOrg trabaja en Lima, Perú.</p>
                    </div><!-- end clearfix -->
                </div><!-- end col -->
        ...
        <div class="container">
            <div class="footer-distributed">
                <div class="footer-left">
                    <p class="footer-company-name">All Rights Reserved. &copy; 2019 <a href="#">TravelOrg</a> Design By : <a href="https://html.design/">html design</a></p>
                </div>

                <div class="footer-right">
                    <form method="get" action="#">
                        <input placeholder="Suscribete a nuestro boletin..." name="search">
